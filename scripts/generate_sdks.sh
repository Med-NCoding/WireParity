...
#
# Generates untouched TypeScript and Python SDKs from the canonical PetStore
...
# ---------------------------------------------------------------------------
echo "[1/2] Generating TypeScript SDK (typescript-fetch) → $TS_OUT"
...
# Python SDK (urllib3)
# ---------------------------------------------------------------------------
echo "[2/2] Generating Python SDK (python/urllib3) → $PY_OUT"
npx --yes @openapitools/openapi-generator-cli generate \
